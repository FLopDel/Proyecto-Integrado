<template>
    <footer class="bg-black/80 dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-xs text-white sm:text-center dark:text-white font-baskerville">© 2023 Todos los derechos reservados.
                </span>
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="#" class="text-white hover:text-gray-900 dark:hover:text-white">
                        <svg class="w-5 h-5 animate-bounce" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
